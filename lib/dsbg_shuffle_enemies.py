try:
    ...
    Enemy(id=5, name="Bonewheel Skeleton", expansions=set(["Painted World of Ariamis"]), health=1, difficultyTiers={1: {"toughness": 37664, "difficulty": {1: 210.86, 2: 227.08, 3: 243.3, 4: 263.26}}, 2: {"toughness": 42968, "difficulty": {1: 39.13, 2: 42.14, 3: 45.15, 4: 48.86}}, 3: {"toughness": 88396, "difficulty": {1: 113.77, 2: 122.53, 3: 131.28, 4: 142.05}}})
    ...
    Enemy(id=10, name="Falchion Skeleton", expansions=set(["Executioner Chariot"]), health=1, difficultyTiers={1: {"toughness": 37664, "difficulty": {1: 77.71, 2: 77.71, 3: 77.71, 4: 77.71}}, 2: {"toughness": 42968, "difficulty": {1: 19.89, 2: 19.89, 3: 19.89, 4: 19.89}}, 3: {"toughness": 88396, "difficulty": {1: 46.61, 2: 46.61, 3: 46.61, 4: 46.61}}})
    ...
    Enemy(id=19, name="Necromancer", expansions=set(["Tomb of Giants"]), difficultyTiers={1: {"toughness": 6001, "difficulty": {1: 368.72, 2: 397.08, 3: 425.43, 4: 460.35}}, 2: {"toughness": 9397, "difficulty": {1: 99.42, 2: 107.07, 3: 114.7, 4: 124.11}}, 3: {"toughness": 30671, "difficulty": {1: 196.94, 2: 212.08, 3: 227.24, 4: 245.88}}})
    ...
    Enemy(id=29, name="Skeleton Beast", expansions=set(["Tomb of Giants"]), difficultyTiers={1: {"toughness": 3975, "difficulty": {1: 1997.94, 2: 2151.63, 3: 2305.31, 4: 2494.47}}, 2: {"toughness": 4949, "difficulty": {1: 339.75, 2: 365.89, 3: 392.02, 4: 424.19}}, 3: {"toughness": 17101, "difficulty": {1: 588.1, 2: 633.34, 3: 678.58, 4: 734.26}}})
    Enemy(id=30, name="Skeleton Soldier", expansions=set(["Tomb of Giants"]), health=1, difficultyTiers={1: {"toughness": 33314, "difficulty": {1: 69.46, 2: 74.8, 3: 80.14, 4: 86.72}}, 2: {"toughness": 32175, "difficulty": {1: 23.23, 2: 25.02, 3: 26.8, 4: 29}}, 3: {"toughness": 64201, "difficulty": {1: 57.26, 2: 61.66, 3: 66.07, 4: 71.49}}})
    ...
    Enemy(id=38, name="Kirk, Knight of Thorns", expansions=set(["Phantoms"]), cards=3, difficultyTiers={1: {"toughness": 4599, "difficulty": {1: 410.77, 2: 424.62, 3: 438.47, 4: 455.52}}, 2: {"toughness": 6715, "difficulty": {1: 73.83, 2: 76.34, 3: 78.85, 4: 81.94}}, 3: {"toughness": 15341, "difficulty": {1: 164.09, 2: 169.35, 3: 174.62, 4: 181.11}}})
    Enemy(id=39, name="Longfinger Kirk", expansions=set(["Phantoms"]), cards=3, difficultyTiers={1: {"toughness": 1455, "difficulty": {1: 3468.73, 2: 3549.87, 3: 3631, 4: 3730.86}}, 2: {"toughness": 1919, "difficulty": {1: 715.73, 2: 732.31, 3: 748.89, 4: 769.31}}, 3: {"toughness": 6851, "difficulty": {1: 1234, 2: 1259.93, 3: 1285.86, 4: 1317.78}}})
    ...
    Enemy(id=41, name="Maneater Mildred", expansions=set(["Phantoms"]), cards=3, difficultyTiers={1: {"toughness": 2326.8, "difficulty": {1: 1323.18, 2: 1424.96, 3: 1526.74, 4: 1652.01}}, 2: {"toughness": 3808, "difficulty": {1: 154.18, 2: 166.04, 3: 177.9, 4: 192.5}}, 3: {"toughness": 9224.4, "difficulty": {1: 332.14, 2: 357.69, 3: 383.24, 4: 414.69}}})
    Enemy(id=42, name="Marvelous Chester", expansions=set(["Phantoms"]), cards=3, difficultyTiers={1: {"toughness": 1874, "difficulty": {1: 2866.66, 2: 2883.76, 3: 2900.87, 4: 2921.92}}, 2: {"toughness": 3216, "difficulty": {1: 429.01, 2: 431.62, 3: 434.24, 4: 437.46}}, 3: {"toughness": 9666, "difficulty": {1: 816.81, 2: 822.75, 3: 828.69, 4: 836.01}}})
    ...
    Enemy(id=44, name="Oliver the Collector", expansions=set(["Phantoms"]), cards=3, difficultyTiers={1: {"toughness": 4095.71, "difficulty": {1: 947.49, 2: 985.72, 3: 1023.95, 4: 1071}}, 2: {"toughness": 5825.71, "difficulty": {1: 131.73, 2: 136.9, 3: 142.08, 4: 148.44}}, 3: {"toughness": 12000, "difficulty": {1: 283.54, 2: 293.32, 3: 303.1, 4: 315.14}}})
    ...
    Enemy(id=46, name="Xanthous King Jeremiah", expansions=set(["Phantoms"]), cards=3, difficultyTiers={1: {"toughness": 6038.5, "difficulty": {1: 510.85, 2: 543.24, 3: 575.64, 4: 615.5}}, 2: {"toughness": 11494.5, "difficulty": {1: 82.36, 2: 87.56, 3: 92.75, 4: 99.15}}, 3: {"toughness": 19651, "difficulty": {1: 110.05, 2: 116.94, 3: 123.84, 4: 132.33}}})
    ...
    Enemy(id=48, name="Voracious Mimic", expansions=set(["Explorers"]), cards=4, difficultyTiers={1: {"toughness": 1139, "difficulty": {1: 3090.96, 2: 3198.91, 3: 3306.86, 4: 3439.72}}, 2: {"toughness": 1569, "difficulty": {1: 614.01, 2: 635.58, 3: 657.15, 4: 683.7}}, 3: {"toughness": 5421, "difficulty": {1: 1098.95, 2: 1136.39, 3: 1173.82, 4: 1219.89}}})
