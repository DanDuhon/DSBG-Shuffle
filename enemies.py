...
Enemy(name="Black Hollow Mage", expansion="The Executioner's Chariot", numberOfModels=2, health=5, armor=2, resist=3, attacks=[4], attackType=["magic"], dodge=2, move=[0], attackRange=[4], difficulty=486.22)
Enemy(name="Bonewheel Skeleton", expansion="Painted World of Ariamis", numberOfModels=2, health=1, armor=1, resist=1, attacks=[4,4], attackType=["physical", "physical"], dodge=2, move=[1, 1], attackRange=[0, 0], difficulty=64.69)
...
Enemy(name="Crow Demon", expansion="Painted World of Ariamis", numberOfModels=2, health=5, armor=1, resist=2, attacks=[6], attackType=["physical"], dodge=2, move=[4], attackRange=[0], difficulty=377.33)
...
Enemy(name="Engorged Zombie", expansion="Painted World of Ariamis", numberOfModels=2, health=1, armor=2, resist=2, attacks=[4], attackType=["magic"], dodge=1, move=[1], attackRange=[0], difficulty=76.08)
Enemy(name="Falchion Skeleton", expansion="The Executioner's Chariot", numberOfModels=2, health=1, armor=1, resist=1, attacks=[3], attackType=["physical"], attackEffect=["bleed"], dodge=1, move=[2], attackRange=[0], difficulty=61.68)
...
Enemy(name="Giant Skeleton Archer", expansion="Tomb of Giants", numberOfModels=2, health=5, armor=1, resist=1, attacks=[2,5], attackType=["physical", "physical"], dodge=2, move=[0, 0], attackRange=[0, 4], difficulty=264.29)
Enemy(name="Giant Skeleton Soldier", expansion="Tomb of Giants", numberOfModels=2, health=5, armor=1, resist=1, attacks=[2,5], attackType=["physical", "physical"], dodge=1, move=[1, 1], attackRange=[0, 1], difficulty=165.89)
...
Enemy(name="Necromancer", expansion="Tomb of Giants", numberOfModels=2, health=5, armor=1, resist=2, attacks=[3], attackType=["magic"], dodge=1, move=[0], attackRange=[4], difficulty=252.17)
Enemy(name="Phalanx", expansion="Painted World of Ariamis", numberOfModels=1, health=5, armor=1, resist=1, attacks=[5], attackType=["physical"], dodge=1, move=[0], attackRange=[1], difficulty=152.19)
Enemy(name="Phalanx Hollow", expansion="Painted World of Ariamis", numberOfModels=5, health=1, armor=1, resist=1, attacks=[4], attackType=["physical"], dodge=1, move=[0], attackRange=[1], difficulty=22.81)
...
Enemy(name="Skeleton Archer", expansion="Tomb of Giants", numberOfModels=3, health=1, armor=1, resist=1, attacks=[4], attackType=["physical"], dodge=1, move=[0], attackRange=[4], difficulty=50.75)
Enemy(name="Skeleton Beast", expansion="Tomb of Giants", numberOfModels=1, health=5, armor=2, resist=2, attacks=[4,4], attackType=["physical", "physical"], dodge=2, move=[1, 1], attackRange=[0, 0], difficulty=278.10)
Enemy(name="Skeleton Soldier", expansion="Tomb of Giants", numberOfModels=3, health=1, armor=2, resist=1, attacks=[2], attackType=["physical"], attackEffect=["bleed"], dodge=1, move=[1], attackRange=[0], difficulty=52.59)
Enemy(name="Snow Rat", expansion="Painted World of Ariamis", numberOfModels=2, health=1, armor=0, resist=1, attacks=[3], attackType=["physical"], attackEffect=["poison"], dodge=1, move=[4], attackRange=[0], difficulty=52.27)
